...
ActiveRecord::Schema.define(version: 20160517203022) do
  ...
  add_index "media_files", ["media_type"], name: "index_media_files_on_media_type", using: :btree
  add_index "media_files", ["tweet_id"], name: "index_media_files_on_tweet_id", using: :btree
  ...
  add_index "tweets", ["media_type"], name: "index_tweets_on_media_type", using: :btree
